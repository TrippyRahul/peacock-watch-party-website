        ...
        <div className='w-[90%] md:w-[85%] p-10 border-[#D8D40C] rounded-xl border mx-auto'>
            ...
            <div className='pt-4'>
               ...
               <ul className='text-[2rem]'>
                 <li className='pt-10'><span className='text-[#D8D40C] text-[2.2rem] font-semibold'>Installation : </span><span>When you install the <a href='/' className='text-blue-400'>Peacock Watch Party</a> browser extension, you are assigned a unique identifier stored on our servers. This identifier helps authenticate and access synchronized watch parties and gather anonymous usage statistics.</span></li>
